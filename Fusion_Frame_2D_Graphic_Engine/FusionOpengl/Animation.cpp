...
FUSIONOPENGL::Animation::Animation(const char* AnimationPath, Model* model)
{
...
FUSIONOPENGL::Bone* FUSIONOPENGL::Animation::FindBone(const std::string& name)
{
    auto iter = std::find_if(Bones.begin(), Bones.end(), 
        [&](FUSIONOPENGL::Bone& Bone)
        {
...
void FUSIONOPENGL::Animation::ReadMissingBones(const aiAnimation* animation, Model& model)
{
...
void FUSIONOPENGL::Animation::ReadHeirarchyData(BoneNodeData& dest, const aiNode* src)
{
    assert(src);
