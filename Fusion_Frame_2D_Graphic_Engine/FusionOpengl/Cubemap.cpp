...
FUSIONOPENGL::CubeMap::CubeMap(std::vector<std::string> texture_faces ,Shader &CubeMapShader)
{
...
FUSIONOPENGL::CubeMap::CubeMap(GLuint CubeMap, Shader& CubeMapShader)
{
...
FUSIONOPENGL::CubeMap::CubeMap(Shader& CubeMapShader)
{
    cubemapshader = &CubeMapShader;
...
FUSIONOPENGL::CubeMap::~CubeMap()
{
    glDeleteTextures(1, &this->cubemaptextureID);
}

void FUSIONOPENGL::CubeMap::Draw(Camera3D &camera, Vec2<float> windowSize)
{
...
void FUSIONOPENGL::CubeMap::SetPreFilteredEnvMap(GLuint preFilteredEnvironmentMapID)
{
    this->PrefilteredEnvMap = preFilteredEnvironmentMapID;
}

void FUSIONOPENGL::CubeMap::SetConvDiffCubeMap(GLuint ConvDiffCubeMapID)
{
    this->ConvDiffCubeMap = ConvDiffCubeMapID;
}

std::pair<GLuint, int> FUSIONOPENGL::HDRItoCubeMap(const char* HDRI, unsigned int CubeMapSize, GLuint HDRItoCubeMapShader)
{
...
std::pair<GLuint, int> FUSIONOPENGL::ConvolutateCubeMap(GLuint CubeMap, GLuint ConvolutateCubeMapShader)
{
...
std::pair<GLuint, int> FUSIONOPENGL::PreFilterCubeMap(GLuint CubeMap, GLuint PreFilterCubeMapShader)
{
...
std::pair<GLuint, int> FUSIONOPENGL::ComputeLUT(Shader& LUTshader)
{
    GLuint fbo, LUT, rbo;
...
int FUSIONOPENGL::ImportCubeMap(const char* HDRIfilePath , unsigned int CubeMapSize , CubeMap& cubemap, GLuint HDRItoCubeMapShader, GLuint ConvolutateCubeMapShader, GLuint PrefilterHDRIShader)
{
