...
void FUSIONOPENGL::Mesh3D::Draw(Camera3D& camera, Shader& shader, Material material, std::function<void()>& ShaderPreperations, CubeMap& cubeMap , float EnvironmentAmbientAmount)
{
	shader.use();
	ObjectBuffer.BindVAO();
	ShaderPreperations();
